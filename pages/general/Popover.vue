<template>
  <div>
    <h1>Popover</h1>
    <p class="bd-lead">Popovers display floating content next to a target element.</p>
    <rd-popover/>
    <h2>Example</h2>
    ...
    <example>
      ...
      >Click to toggle popover</rd-button>
    </example>
    <highlight
      code="&lt;rd-button
  type=&quot;button&quot;
...
&lt;/rd-button&gt;"
    ...
    <example>
      <rd-popover :popover="{content:'Disabled popover'}">
        <rd-button style="pointer-events: none;" disabled primary>Disabled button</rd-button>
      </rd-popover>
    </example>
    <highlight
      code="&lt;rd-popover
...
&lt;/rd-popover&gt;"
    ...
    <properties type="props" :data="propsPopover"/>
  </div>
</template>
